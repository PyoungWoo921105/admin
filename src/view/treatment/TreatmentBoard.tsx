...
import TreatmentHistoryBoard from 'view/treatment/history/TreatmentHistoryBoard';
import TreatmentCertificationBoard from 'view/treatment/certification/TreatmentCertificationBoard';
